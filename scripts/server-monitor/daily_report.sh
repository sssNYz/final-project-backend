...
BACKUP_SCRIPT="/home/deploy/final-project-backend/scripts/server-monitor/backup_data.sh"
SCAN_SCRIPT="/home/deploy/final-project-backend/scripts/server-monitor/perform_scan.sh"
