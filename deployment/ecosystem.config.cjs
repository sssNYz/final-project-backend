module.exports = {
  apps: [
    ...
    {
      name: 'snooze-cron-worker',
      script: 'npx',
      args: 'tsx server/workers/snoozeCron.worker.ts',
      cwd: '/home/deploy/final-project-backend',
      env: {
        NODE_ENV: 'production'
      },
      error_file: './logs/snooze-cron-error.log',
      out_file: './logs/snooze-cron-out.log',
      log_date_format: 'YYYY-MM-DD HH:mm:ss Z',
      merge_logs: true,
      autorestart: true,
      watch: false,
    ...
    },
    {
      name: 'queue-worker',
      script: 'npx',
      args: 'tsx server/workers/queueWorker.ts',
      cwd: '/home/deploy/final-project-backend',
      env: {
        NODE_ENV: 'production'
      },
